...
@Component
public class MyIpCountGateWayFilter implements GlobalFilter, Ordered {

    private static final Logger LOGGER = LoggerFactory.getLogger(MyIpCountGateWayFilter.class);
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        LOGGER.info("IP:{} ,令牌通可用的Token数量:{} ", ip, bucket.getAvailableTokens());
